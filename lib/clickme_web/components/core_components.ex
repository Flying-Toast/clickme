defmodule ClickmeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ClickmeWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ClickmeWeb.Gettext, "errors", msg, opts)
    # end
